          ...
          <div className="container relative z-10 px-4 md:px-6">
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Enterprise Networking</h1>
                <p className="text-xl text-muted-foreground">
                  Enterprise-grade network design, implementation, and management services to keep your business
                  connected and secure.
                </p>
                <div className="mt-8 space-y-6">
                  <h2 className="text-2xl font-bold">Our Networking Services Include:</h2>
                  <ul className="space-y-6">
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold">Network Infrastructure Design</h3>
                        <p className="text-muted-foreground mt-1">
                          Custom network architecture designed for your specific business needs, ensuring optimal
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold">Wireless Solutions</h3>
                        <p className="text-muted-foreground mt-1">
                          High-performance wireless networks with comprehensive coverage, supporting the latest Wi-Fi
                          standards.
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mt-1">
                          Robust security measures including firewalls, intrusion detection, and prevention systems to
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-16">
              ...
              <div className="space-y-3">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Our Networking Process</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  We follow a structured approach to deliver reliable networking solutions
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-12 py-8 md:grid-cols-4">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <p className="text-muted-foreground">
                  We analyze your current infrastructure and business requirements to identify needs and opportunities.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="relative">
                ...
                <p className="text-muted-foreground">
                  Our engineers create a detailed network design tailored to your specific requirements.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="relative">
                ...
                <p className="text-muted-foreground">
                  We deploy your network solution with minimal disruption to your business operations.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="relative">
                ...
                <p className="text-muted-foreground">
                  Rigorous testing ensures your network performs optimally under various conditions.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="relative z-10 px-8 py-16 md:p-16 lg:p-20">
                <div className="mx-auto max-w-3xl text-center">
                  ...
                  <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl/relaxed mb-8">
                    Contact us today to schedule a consultation with our networking experts and take the first step
                    toward a more reliable, secure, and efficient network.
                  </p>
